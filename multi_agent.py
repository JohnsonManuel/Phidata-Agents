...
# creative_blog_agent = Agent(
#     name="Creative Blog Generator",
#     team=[google_search_agent, youtube_agent],
#     instructions=[
#         "First, use the YouTube agent to retrieve captions from the provided YouTube video.",
#         "Then, analyze the captions to extract key ideas, notable quotes",
#     ],
#     model = Groq(id="llama3-groq-70b-8192-tool-use-preview"),
#     # show_tool_calls=True,
#     markdown=True,
